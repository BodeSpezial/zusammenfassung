...
\begin{document}
        ...
        %% Merken
        \section{Merks\"atze}%
        \begin{sts}{Feldst\"arke}{}
                $$
                Felds = \frac{F_{Feld}}{Quanta}
                $$
        \end{sts}

        \begin{sts}{Energie}{Unter der Energie einer K\"orpers oders Systems versteht man seine F\"ahigkeit Arbeit zu verrichten}
        \end{sts}
        ...
        \begin{sts}{Orts-Zeit-Gesetz}{}
                $$
                s(t) = v\cdot t + s_0
                $$
        \end{sts}

        \begin{sts}{Geschwindigkeits-Zeit-Gesetz}{}
                $$
                v(t) = at+v_0
                $$
        \end{sts}
        ...
        \begin{sts}{Winkelgeschwindigkeit}{}
                $$
                \omega = \frac{\Delta\phi}{\Delta t}
                $$
        \end{sts}

        \begin{sts}{Bahngeschwindigkeit}{}
                $$
                v = \omega r
                $$
        \end{sts}
        ...
        \begin{sts}{elektrische Stromst\"arke}{}
                $$
                Q=I\cdot t
                $$
        \end{sts}
        ...
        \begin{sts}{Lorentzkraft}{Kraft auf einen Ladungstr\"ager, mit der Ladung $Q$, welches sich mit der Geschwindigkeit $v$ durch ein Magnetfeld mit der Flussdichte $B$ bewegt.}
                $$
                F_L = Q\cdot v\cdot B
                $$
        \end{sts}
